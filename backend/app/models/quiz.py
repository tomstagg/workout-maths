...
from sqlalchemy import Integer, SmallInteger, DateTime, ForeignKey, Float, Boolean
...
class QuizSession(Base):
    ...
    completed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default="now()")
    ...
    user: Mapped["User"] = relationship(back_populates="quiz_sessions")  # type: ignore[name-defined]
    answers: Mapped[list["QuizAnswer"]] = relationship(
        back_populates="session", cascade="all, delete-orphan", order_by="QuizAnswer.position"
    )
