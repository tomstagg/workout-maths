...
from sqlalchemy import String, Integer, SmallInteger, DateTime, ForeignKey, UniqueConstraint, func
...
class User(Base):
    ...
    quiz_sessions: Mapped[list["QuizSession"]] = relationship(  # type: ignore[name-defined]
        back_populates="user", cascade="all, delete-orphan"
    )
